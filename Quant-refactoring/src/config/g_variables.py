...
사용법:
    Feature 선택::
        ...
        from src.config.g_variables import ratio_col_list, meaning_col_list
    ...
    섹터 분류::
        ...
        from src.config.g_variables import sector_map
    ...
    데이터 품질 처리::
        ...
        from src.config.g_variables import sparse_col_list
